...
namespace Loan.Data.Migrations
{
    ...
    [Migration("20220712231438_update_client")]
            ...
            modelBuilder.Entity("Loan.Entity.Client", b =>
                {
                    ...
                    b.Property<string>("FullAddress")
                        ...
                        .HasColumnType("nvarchar(max)")
                        .HasComputedColumnSql("replace(replace([AddressLine1] + ' ' + [AddressLine2] + ' ' + [AddressLine3], '  ',' '), '  ', ' ')");

                    b.Property<string>("FullName")
                        .IsRequired()
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("nvarchar(max)")
                        .HasComputedColumnSql("replace(replace([FirstName] + ' ' + [MiddleName] + ' ' + [LastName], '  ',' '), '  ', ' ')");
